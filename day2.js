...
const answer = [
    ...
    'eA=)#4HH=Q^4nVHx^w,!T<11M~RQ.iI7Xk?lbtc d35csP&k1Xk2zk87NF^w691a4_xuc'
  ]

let answers = []

for(let i = 0; i < answer.length; i++ ){
    answers.push(answer[i].charAt(0))
}
